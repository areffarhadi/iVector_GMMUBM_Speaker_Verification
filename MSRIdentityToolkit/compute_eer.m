function [eer, dcf08, dcf10, dcf_ivector_challenge, dcf_ivector_challenge_threshold, eer_thre] = compute_eer(scores, labels, showfig)
...
%   - dcf_ivector_challenge    : minimum DCF with IVector Challenge parameters
%
...
eer_thre = (scores(I(idx1)) + scores(I(idx2))) / 2;
